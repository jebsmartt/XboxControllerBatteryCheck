...
- Provides battery percentage for connected Xbox-brand controllers
- Supports displaying multiple controllers at once
- Automatically re-polls for an updated battery percentage every 10 seconds
